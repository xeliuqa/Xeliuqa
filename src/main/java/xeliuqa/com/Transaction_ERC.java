...
public class Transaction_ERC extends AppCompatActivity{
    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL("http://api.ethplorer.io/getAddressHistory/"+address+"?apiKey=" + apikey + contract+"&type=transfer");
    ...
    private void getData() {
        StringRequest stringRequest=new StringRequest(Request.Method.GET, "https://api.ethplorer.io/getAddressHistory/"+address+"?apiKey=" + apikey +"&token="+contract+"&type=transfer", new Response.Listener<String>() {
            @Override
