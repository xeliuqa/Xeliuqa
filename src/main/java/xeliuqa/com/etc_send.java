...
public class etc_send extends AppCompatActivity {
    public static TextView etc_dataSafeGas;
    public static TextView etc_dataProposeGas;
    public static TextView etc_dataFastGas;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_etc_send);
        ...
        result = (TextView) findViewById(R.id.ETC_Balance);
        ...
        usd = (TextView)findViewById(R.id.ETC_usd);
        usdA = (TextView)findViewById(R.id.usd);
        scan=(ImageButton) findViewById(R.id.btn_scan);
        max = (TextView)findViewById(R.id.max);
        back = (ImageView) findViewById(R.id.back);
        logo = (ImageView) findViewById(R.id.logo);
        logo.setBackgroundResource(R.drawable.etc);

        etc_dataSafeGas = (TextView) findViewById(R.id.etc_dataSafeGas);
        etc_dataProposeGas = (TextView) findViewById(R.id.etc_dataProposeGas);
        etc_dataFastGas = (TextView) findViewById(R.id.etc_dataFastGas);
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    usd.setText("$"+String.valueOf(etcs));
                } catch (Exception e){
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(etc_send.this, Transaction_ETC.class);
                startActivity(i);
            }
        });
            ...
            public void run() {
                ...
                if (!mStopHandler) {
                    ...
                    try {
                        ...
                        bals= rat * bals;
                        String etcs = String.format("%.2f", bals);
                        usdA.setText("$"+String.valueOf(etcs));
                ...
                if (to.isEmpty() || to.length() == 0 || to.equals("") || to == null) {
                    ...
                    if (toamount > d){
                        ...
                        if (otp_status.equals("1")){
                            ...
                            LayoutInflater li = LayoutInflater.from(etc_send.this);
                            View promptsView = li.inflate(R.layout.activity_otp, null);

                            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(etc_send.this);
                                            ...
                                            new DialogInterface.OnClickListener() {
                                                public void onClick(DialogInterface dialog,int id) {
                                                    ...
                                                    if (otp.equals(OTPs)){
                                                        ...
                                                        alert.showDialog(etc_send.this, "OTP is wrong.");
                                                    }
                                                }
                                            })
    ...
    private void displayLoader() {
        pDialog = new ProgressDialog(etc_send.this);
        ...
        JsonObjectRequest jsArrayRequest = new JsonObjectRequest
                (com.android.volley.Request.Method.POST, api_url, request, new com.android.volley.Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        pDialog.dismiss();
                        try {
                            //Toast.makeText(etc_send.this, response.toString(), Toast.LENGTH_LONG).show();
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            ...
                            Toast.makeText(etc_send.this, e.toString(), Toast.LENGTH_LONG).show();
                        }
                    }
                });
            }
    ...
    private void getUSD_ETC() {
        ...
        JsonObjectRequest jsArrayRequest = new JsonObjectRequest
                (com.android.volley.Request.Method.GET, "https://min-api.cryptocompare.com/data/price?fsym=ETC&tsyms=USD", request, new com.android.volley.Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
                        try {
                            String res = response.toString();
