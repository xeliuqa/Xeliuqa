...
public class Signup extends AppCompatActivity {
    ...
    private String register_url = "http://"+ conf.url() +"/wallet/register.php";
    private String api_url = "http://"+ conf.url()+":8080/v1/generate/eth";
    private String api_url2 = "http://"+ conf.url() +":8081/v1/btc";
    ...
    private boolean validateInputs() {
        if (KEY_EMPTY.equals(names)) {
            name.setError("Name your Wallet");
            name.requestFocus();
            return false;
                ...
                (com.android.volley.Request.Method.POST, api_url3, request, new com.android.volley.Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            if (res.contains("@")){
                                //Display error message if username is already exists
