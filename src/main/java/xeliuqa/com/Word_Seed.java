                ...
                (com.android.volley.Request.Method.POST, api_url, request, new com.android.volley.Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            BTC_address = enc.encrypt(key,initVector,btcaddress);
                            BTC_secret = enc.encrypt(key,initVector,btckey);
                            word_seed =enc.encrypt(key,initVector,words);
                            //pass =enc.encrypt(key,initVector,pass);
                            email =enc.encrypt(key,initVector,words);
                            seed.setText(words);
                ...
                (com.android.volley.Request.Method.POST, api_url2, request, new com.android.volley.Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            ETH_address = enc.encrypt(key,initVector,ethaddress);
                            ETH_secret = enc.encrypt(key,initVector,add);
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }catch (Exception e){
                            e.printStackTrace();
