...
public class Transaction_ETH extends AppCompatActivity {
    ...
    private void getData() {
        StringRequest stringRequest=new StringRequest(Request.Method.GET, "https://api.ethplorer.io/getAddressTransactions/" +address+ "?apiKey=" + apikey, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {
                    ...
                    for(int i=0;i<dataArray.length();i++){
                        ...
                        {
                            String EthAm= json_data.getString("value");
                            Double vals = Double.parseDouble(EthAm);
