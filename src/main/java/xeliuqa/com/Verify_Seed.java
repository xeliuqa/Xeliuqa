...
public class Verify_Seed extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataSeeds = enc.decrypt(key,initVector,seeds);
        pwd = enc.decrypt(key,initVector,pass);
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            if (resutlt.equals("success")){
                                ...
                                //session.loginUser(seeds, email,ETH_address,ETH_secret,BTC_address,BTC_secret,"1234", BCH_address, BCH_secret);
